...
const Schema: z.ZodType<Prisma.TaskUncheckedCreateNestedManyWithoutListInput> =
  z
    .object({
      create: z
        .union([
...
export const TaskUncheckedCreateNestedManyWithoutListInputObjectSchema = Schema;
